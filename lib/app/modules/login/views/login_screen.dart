...
import '../../../components/loading_request.dart';
          ...
          WillPopScope(
            ...
            child: !_loading
                ? AnimatedPadding(
                    ...
                    padding:
                        EdgeInsets.only(bottom: MediaQuery.of(context).viewInsets.bottom == 0 ? 0 : deviceHeight * 0.3),
                    child: Stack(
                      children: [
                        Positioned(
                          bottom: 0,
                                      ...
                                      child: TextField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          enabledBorder: OutlineInputBorder(
                                            borderSide:
                                                BorderSide(color: _emailEmpty ? Colors.red : Colors.black, width: 2),
                                            borderRadius: BorderRadius.circular(deviceWidth * 0.03),
                                            gapPadding: 0,
                                          ),
